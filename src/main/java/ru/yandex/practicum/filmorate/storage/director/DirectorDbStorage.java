...
public class DirectorDbStorage implements DirectorStorage {
    ...
    public Director createDirector(Director director) {
        ...
        Map<String, Object> params = Map.of("dir_ext_id", director.getExtId(), "dir_name", director.getName());
    ...
    public Director updateDirector(Director director) {
        ...
        String sqlDirector = "update directors set dir_ext_id = ?, dir_name = ? where dir_id = ?";
        jdbcTemplate.update(sqlDirector, director.getExtId(), director.getName(), director.getId());
